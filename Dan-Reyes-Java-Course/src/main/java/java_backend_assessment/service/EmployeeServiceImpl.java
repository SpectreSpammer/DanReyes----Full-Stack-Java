package java_backend_assessment.service;



import java_backend_assessment.exception.DuplicateEmployeeException;
import java_backend_assessment.exception.EmployeeNotFoundException;
import java_backend_assessment.model.DeveloperAssessment;
import java_backend_assessment.model.EmployeeAssessment;
import java_backend_assessment.model.ManagerAssessment;
...
public class EmployeeServiceImpl {
    ...
    public void addSpecificEmployeeAndWriteToExcel(String filename) throws IOException {
        ...
        EmployeeAssessment dan = new ManagerAssessment(
                4,
                "Dan",
                "Reyes",
                "Devops",
                ...
                250000.0,
                new HashSet<>(Arrays.asList(
                        "Free Car worth 5 million",
                        "2 million worth of health insurance"
                        )),
                70000.0
        );
