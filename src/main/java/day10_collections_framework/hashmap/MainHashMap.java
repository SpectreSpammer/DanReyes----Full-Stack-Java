...
public class MainHashMap {
    public static void main(String[] args) {
        ...
        EmployeeServiceHashmap employees = new EmployeeServiceHashmap();

        //adding of employees
        employees.addEmployee(new EmployeeHashmap(101,"Dan","IT"));
        employees.addEmployee(new EmployeeHashmap(102,"Nand","Security"));
        employees.addEmployee(new EmployeeHashmap(102,"Nan","Security"));
        employees.addEmployee(new EmployeeHashmap(103,"Usopp","Accounting"));
        employees.addEmployee(new EmployeeHashmap(104,"Nami","Marketing"));
        employees.addEmployee(new EmployeeHashmap(105,"Robin","HR"));
        ...
        int searchById = 102;
        EmployeeHashmap emp = employees.getByEmployeeId(searchById);
